...
if (isset($_POST["enviar"])) { //si se cumple, significa que me enviaron el formulario
	...
	if($correcto) {
			// si llegamos aqui es porque el dni es numérico y de 8dígitos
			// y además la letra es alfabética y de un solo carácter
