...
$sql="INSERT INTO alumnos VALUES 
		...
		(NULL,'Maria','López Roca','H','13445566T','T-N','OU'),
		(NULL,'Pepe','López Roca','H','23445566T','N','PO'),
		(NULL,'Juan','López Roca','H','33445566T','F-T','CO'),
		(NULL,'Laura','López Roca','H','43445566T','F','LU'),
		(NULL,'Gonzalo','López Roca','H','53445566T','T-N','CO')
	;
";
echo "<hr>$sql";
